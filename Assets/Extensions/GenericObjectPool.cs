...
public sealed class GenericObjectPool : MonoBehaviour
{
	...
	static GenericObjectPool _instance;
	...
	public static GenericObjectPool instance
	{
		get
		{
			...
			_instance = Object.FindObjectOfType<GenericObjectPool>();
			if (_instance != null)
				return _instance;
			...
			_instance = obj.AddComponent<GenericObjectPool>();
			return _instance;
		}
	}
}
...
public static class ObjectPoolExtensions
{
	...
	{
		GenericObjectPool.CreatePool(prefab, 0);
	}
	public static void CreatePool<T>(this T prefab, int initialPoolSize) where T : Component
	{
		GenericObjectPool.CreatePool(prefab, initialPoolSize);
	}
	...
	{
		return GenericObjectPool.Spawn(prefab, parent, position, rotation);
	}
	public static T Spawn<T>(this T prefab, Vector3 position, Quaternion rotation) where T : Component
	{
		return GenericObjectPool.Spawn(prefab, null, position, rotation);
	}
	public static T Spawn<T>(this T prefab, Transform parent, Vector3 position) where T : Component
	{
		return GenericObjectPool.Spawn(prefab, parent, position, Quaternion.identity);
	}
	public static T Spawn<T>(this T prefab, Vector3 position) where T : Component
	{
		return GenericObjectPool.Spawn(prefab, null, position, Quaternion.identity);
	}
	public static T Spawn<T>(this T prefab, Transform parent) where T : Component
	{
		return GenericObjectPool.Spawn(prefab, parent, Vector3.zero, Quaternion.identity);
	}
	public static T Spawn<T>(this T prefab) where T : Component
	{
		return GenericObjectPool.Spawn(prefab, null, Vector3.zero, Quaternion.identity);
	}
	...
	{
		return GenericObjectPool.CountSpawned(prefab);
	}
	...
	{
		return GenericObjectPool.GetSpawned(prefab, list, appendList);
	}
	public static List<GameObject> GetSpawned(this GameObject prefab, List<GameObject> list)
	{
		return GenericObjectPool.GetSpawned(prefab, list, false);
	}
	public static List<GameObject> GetSpawned(this GameObject prefab)
	{
		return GenericObjectPool.GetSpawned(prefab, null, false);
	}
	...
	{
		return GenericObjectPool.GetPooled(prefab, list, appendList);
	}
	public static List<GameObject> GetPooled(this GameObject prefab, List<GameObject> list)
	{
		return GenericObjectPool.GetPooled(prefab, list, false);
	}
	public static List<GameObject> GetPooled(this GameObject prefab)
	{
		return GenericObjectPool.GetPooled(prefab, null, false);
	}
