...
public class UIScrollViewEditor : Editor
{
	public override void OnInspectorGUI ()
	{
        ...
        SerializedProperty dragProp = NGUIEditorTools.DrawProperty("Drag Effect", serializedObject, "dragEffect");
        if(((UIScrollView.DragEffect)dragProp.intValue) == UIScrollView.DragEffect.MomentumAndSpring) {
