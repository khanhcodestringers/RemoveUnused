...
public class SSController : MonoBehaviour 
{
	...
	[SerializeField]
	private bool shouldChangeCanvasOrder = true;
	public bool 	ShouldChangeCanvasOrder { get{return shouldChangeCanvasOrder;} set{shouldChangeCanvasOrder = value;}}
	#endregion
