...
namespace CSSynth.Synthesis
{
    public class StreamSynthesizer
    {
        ...
        public Action<int> OnSampleCounterChanged;
        //--Public Methods
        ...
        public StreamSynthesizer(int sampleRate, int audioChannels, int bufferSizeInMilliseconds, int maxpoly)
        {
            this.sampleRate = sampleRate;
            this.audioChannels = audioChannels;
            this.samplesperBuffer = bufferSizeInMilliseconds;
            this.polyphony = maxpoly;
            setupSynth();
        }
        ...
        private void FillWorkingBuffer()
        {
            ...
            if (seq != null && seq.isPlaying)//Use sequencer
            {
                ...
                if (OnSampleCounterChanged != null) {
                    OnSampleCounterChanged(samplesperBuffer);
                }
            }
            else //Manual mode
            {
